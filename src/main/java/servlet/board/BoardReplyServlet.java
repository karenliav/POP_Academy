...
public class BoardReplyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BoardDTO parent = boardDAO.getBoard(boardID,boardName);
		boardDAO.replyUpdate(parent,boardName);
		boardDAO.reply(userID, boardTitle, boardContent, boardFile, boardRealFile, parent,boardName);
