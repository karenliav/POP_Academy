...
public class BoardUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(file != null) {
			...
			boardFile = boardDAO.getFile(boardID, boardName);
			boardRealFile = boardDAO.getRealFile(boardID, boardName);
		}
		
		boardDAO.update(boardID, boardTitle, boardContent, boardFile, boardRealFile, boardName);
